codeunit 95104 "Strapi Manager"
{
    ...
    var
        ...
        JToken: JsonToken;
    begin
        Url := CompanyInfo."Strapi Base URL" + '/api/' + CompanyInfo."Strapi Collection Name" + '/' + RootFolderID;
        Respuesta := RestApiToken(Url, CompanyInfo."Strapi API Token", RequestType::patch, RootFolder);
        exit(Respuesta);
    end;
    ...
    internal procedure CopyFile(GoogleDriveID: Text[250]; destino: Text; Name: Text[250]): Text
    var
        RequestType: Option Get,patch,put,post,delete;
        Url: Text;
        Respuesta: Text;
